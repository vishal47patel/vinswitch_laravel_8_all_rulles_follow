            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row with-border mb-2">
                        <div class="col-md-6">
                             <h4 class="page-title"><i class="fa fa-paste" aria-hidden="true"></i> Add New Termination Rate : {{$sofiarateplan->plan_name}}</h4>
                        </div>
                    ...
                    <form action="{{ route('sofiaRate.store',$sofiarateplan->id) }}" method="POST" id="check_validation" class="parsley-examples">
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-2">                                    
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="code" id="code" placeholder="Enter Code" value="{{ old('code') }}" autocomplete = off onkeypress="return onlyNumberKey(event)">
                                </div>
                            ...
                            <div class="col-lg-4 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="buy_rate" id="buy_rate" placeholder="Enter Buy Rate" value="{{ old('buy_rate') }}" autocomplete = off onkeypress="return onlyNumberKey(event)">
                                </div>
                            ...
                            <div class="col-lg-4 mb-2">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fa fa-dollar"></i></span>
                                    <input type="text" class="form-control" name="sale_rate" id="sale_rate" placeholder="Enter Sell Rate" value="{{ old('sale_rate') }}" autocomplete = off>
                                </div>
