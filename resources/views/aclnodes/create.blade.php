            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row with-border mb-2">
                        <div class="col-md-6">
                            <h4 class="page-title"><i class="fa fa-users " aria-hidden="true"></i> Add New ACL</h4>
                        </div>
                    ...
                    <form action="{{ route('aclnodes.store') }}" method="POST" id="check_validation_aclnodes">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4 mb-2 validation_message ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="cidr" id="cidr" placeholder="CIDR" value="{{ old('cidr') }}" autocomplete=off>
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fa fa-keyboard"></i></span>
                                    <input type="text" class="form-control" name="type" id="type" placeholder="Type" value="{{ old('type') }}" autocomplete=off>
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="is_endpoint" title="is_endpoint">
                                        <option value="YES" selected @if('is_endpoint'=='YES' ) selected @endif>YES</option>
                                        <option value="NO" @if('is_endpoint'=='NO' ) selected @endif>NO</option>
                                    </select>
                                </div>
