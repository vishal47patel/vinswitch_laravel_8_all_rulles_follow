            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row with-border mb-2">
                        <div class="col-md-6">
                             <h4 class="page-title"><i class="fa fa-object-group" aria-hidden="true"></i>  Update Termination RatePlan</h4>
                        </div>
                    ...
                    <form action="{{ route('sofiaRateplan.update',$sofiarateplan->id) }}" method="POST" id="check_validation" class="parsley-examples">
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-2">                                    
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="plan_name" id="plan_name" placeholder="Enter Plan Name" value="{{ $sofiarateplan->plan_name }}" autocomplete = off >
                                </div>
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="cc" id="cc" placeholder="Enter Concurrent Call" value="{{ $sofiarateplan->cc }}" autocomplete = off>
                                </div>
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="max_call_length" id="max_call_length" placeholder="Enter Max Call Length" value="{{ $sofiarateplan->max_call_length }}" autocomplete = off>
                                </div>
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="status"  title="Status">
                                      <option value="ACTIVE" @if($sofiarateplan->status == 'ACTIVE') selected @endif>ACTIVE</option>
                                      <option value="INACTIVE" @if($sofiarateplan->status == 'INACTIVE') selected @endif>INACTIVE</option>
                                    </select>
                                </div>
