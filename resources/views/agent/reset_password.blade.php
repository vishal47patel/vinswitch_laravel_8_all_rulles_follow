            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row with-border mb-2">
                        <div class="col-md-6">
                             <h4 class="page-title"><i class="fa fa-unlock-alt" aria-hidden="true"></i> Reset Password <small>(<?php echo 'Account Number: '. $agent->account_code; ?>)</small></h4>
                        </div>
                    ...
                    <form action="{{ route('agent.agentresetpassword',$agent->id) }}" method="POST" id="check_validation">
                    @csrf
                        <div class="row">
