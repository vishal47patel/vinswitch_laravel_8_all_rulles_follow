        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('agent.accountstore') }}" method="POST" id="check_validation" class="parsley-examples">
                    @csrf
                     <div id="basicwizard">
                        ...
                        <div class="tab-content b-0 mb-0 pt-0">
                            ...
                            <div>
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="phoneno" id="phoneno" placeholder="Enter Phone Number" value="{{ $agent['contact_no'] }}" autocomplete = off>
                                    </div>
                            ...
                            <ul class="list-inline mb-0 wizard">
                                <li class="previous list-inline-item">
                                    <a href="{{ URL::to('/agents/customer-info?view=agent.customer_create') }}" class="btn btn-primary"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                                </li>
