            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row with-border mb-2">
                        <div class="col-md-6">
                            <h4 class="page-title"><i class="fas fa-paste" aria-hidden="true"></i> Add Gateway Detail</h4>
                        </div>
                    ...
                    <form action="{{ route('gateways.store') }}" method="POST" id="check_validation_gateway">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4 mb-2 validation_message ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="gateway_name" id="gateway_name" placeholder="Enter Gateway Name" value="{{ old('gateway_name') }}" autocomplete=off>
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="prefix" id="prefix" placeholder="Enter Prefix" value="{{ old('prefix') }}" autocomplete=off>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user-alt"></i></span>
                                    <input type="text" class="form-control" name="auth_username" id="auth_username" placeholder="Enter Auth Username" value="{{ old('auth_username') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="realm" id="realm" placeholder="Enter Realm" value="{{ old('realm') }}" autocomplete=off />
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user-alt"></i></span>
                                    <input type="text" class="form-control" name="from_user" id="from_user" placeholder="Enter From User" value="{{ old('from_user') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="from_domain" id="from_domain" placeholder="Enter From Domain" value="{{ old('from_domain') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="proxy" id="proxy" placeholder="Enter Proxy" value="{{ old('proxy') }}" autocomplete=off />
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="register_proxy" id="register_proxy" placeholder="Enter Register Proxy" value="{{ old('register_proxy') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="outbound_proxy" id="outbound_proxy" placeholder="Enter Outbound Proxy" value="{{ old('outbound_proxy') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="expire_seconds" id="expire_seconds" placeholder="Enter Expire Seconds" value="{{ old('expire_seconds') }}" autocomplete=off />
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="select2-multiple1 form-control" name="register" id="register">
                                        <option value="">Select Register</option>
                                        <option value="TRUE" {{ old("register") == 'TRUE' ? 'selected' : '' }}>TRUE</option>
                                        <option value="FALSE" {{ old("register") == 'FALSE' ? 'selected' : '' }}>FALSE</option>
                                    </select>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-clock"></i></span>
                                    <input type="text" class="form-control" name="retry_seconds" id="retry_seconds" placeholder="Enter Retry Reconds" value="{{ old('retry_seconds') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="ping" id="ping" placeholder="Enter Ping" value="{{ old('ping') }}" autocomplete=off />
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="caller_id_in_from" id="caller_id_in_from" placeholder="Enter Caller Id In From" value="{{ old('caller_id_in_from') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="channels" id="channels" placeholder="Enter Channels" value="{{ old('channels') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="hostname" id="hostname" placeholder="Enter hostname" value="{{ old('hostname') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="select2-multiple1 form-control" name="outbound_default" title="Outbound Default" id="outbound_default">
                                        ...
                                        <option value="YES" {{ old("outbound_default") == 'YES' ? 'selected' : '' }}>YES</option>
                                        <option value="NO" {{ old("outbound_default") == 'NO' ? 'selected' : '' }}>NO</option>
                                    </select>
                                </div>
