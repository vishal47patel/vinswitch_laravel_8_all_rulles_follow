            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row with-border mb-2">
                        <div class="col-md-6">
                             <h4 class="page-title"><i class="fa fa-paste" aria-hidden="true"></i> Add New Origination Bill Plan</h4>
                        </div>
                    ...
                    <form action="{{ route('originationBillPlan.store') }}" method="POST" id="check_validation" class="parsley-examples">
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="bill_plan_type"  title="Type">
                                      ...
                                      <option value="POSTPAID" @if('bill_plan_type' == 'POSTPAID') selected @endif>POSTPAID</option>
                                      <option value="PREPAID" @if('bill_plan_type' == 'PREPAID') selected @endif>PREPAID</option>
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-6 mb-2">                                    
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="bill_plan_name" id="bill_plan_name" placeholder="Enter Bill Plan Name" value="{{ old('bill_plan_name') }}" autocomplete = off >
                                </div>
                                    ...
                                    <select class="form-control" name="origination_rate_plan"  title="Origination Rate Plan">
                                      <option disabled="" selected>Select Origination Rate Plan</option>
                                       @foreach ($OriginationRatePlans as $OriginationRatePlan)
                                        <option value="{{$OriginationRatePlan->id}}" {{ old('origination_rate_plan') == $OriginationRatePlan->id ? 'selected' : '' }}>{{$OriginationRatePlan->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
