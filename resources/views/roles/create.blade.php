            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row with-border mb-2">
                        <div class="col-md-6">
                             <h4 class="page-title"><i class="fa fa-cog" aria-hidden="true"></i> Add Role Detail</h4>
                        </div>
                    ...
                    <form action="{{ route('roles.store') }}" method="POST" id="check_validation" class="parsley-examples">
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <div class="input-group multipleselect">
                                    ...
                                    <option value="{{$permission->id}}" {{ old('id') == $permission->id ? 'selected' : '' }}>{{$permission->name}}</option>
                                    @endforeach
                                    </select>
                                </div>
