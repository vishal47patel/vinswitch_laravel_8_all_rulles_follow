            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row with-border mb-2">
                        <div class="col-md-6">
                            <h4 class="page-title"><i class="fas fa-paste" aria-hidden="true"></i> Edit Number Detail</h4>
                        </div>
                    ...
                    <form action="{{ route('numbers.update',$did->id) }}" method="POST" id="check_validation_did_numbers">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 mb-2 validation_message ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="number_did" id="number_did" placeholder="Enter Number Name" value="{{$did->number_did}}" autocomplete=off>
                                </div>
                            ...
                            <div class="col-lg-6 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="select2-multiple1 form-control" name="number_service_type" title="Service Type" id="number_service_type">
                                        ...
                                        <option value="{{$service->id}}" {{ ($service->id == $did->number_service_type) ? 'selected' : '' }}>{{$service->service_type}}</option>
                                        @endforeach
                                        @endisset
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="number_channel_limit" id="number_channel_limit" placeholder="Enter Username" value="{{ $did->number_channel_limit }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-6 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="select2-multiple1 form-control country_get" data-id="{{$did->number_country}}" name="number_country" title="Country" id="number_country" onchange="getState(this,'number_state')">
                                        <option value="">Select</option>
                                        @isset($countries)
                                        @foreach($countries as $service)
                                        <option value="{{$service->ID}}" {{ ($service->ID == $did->number_country) ? 'selected' : '' }}>{{$service->Name}}</option>
                                        @endforeach
                                        @endisset
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="select2-multiple1 form-control state_set_get" data-id="{{$did->number_state}}" name="number_state" title="State" id="number_state" onchange="getCities(this, 'number_area')">
                                        <option value="">Select</option>
                            ...
                            <div class="col-lg-6 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="select2-multiple1 form-control city_set" data-id="{{$did->number_area}}" name="number_area" title="Area" id="number_area">
                                        <option value="">Select</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-lg-6-6 mb-2 validation_message">
                                <label for="for-from_user" class="form-label">Description</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-user-alt"></i></span>
                                    <input type="text" class="form-control" name="number_description" id="number_description" placeholder="Enter From User" value="{{ $did->number_description }}" autocomplete=off />
                                </div>
