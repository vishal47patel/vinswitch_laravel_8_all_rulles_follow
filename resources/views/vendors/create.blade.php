        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('vendors.store') }}" method="POST" id="check_validation_vendors">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4 mb-2 validation_message ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="vendor_name" id="vendor_name" placeholder="Enter Vendor Name" value="{{ old('vendor_name') }}" autocomplete=off>
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="vendor_code" id="vendor_code" placeholder="Enter Username" value="{{ old('vendor_code') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="did_type" id="did_type" placeholder="Enter Did Type" value="{{ old('did_type') }}" autocomplete=off />
                                </div>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="select2-multiple1 form-control" name="status" title="Status" id="statusc">
                                        ...
                                        <option value="DISABLE" {{ (old('status') == 'DISABLE' || old('status') == '') ? 'selected' : '' }}>DISABLE</option>
                            ...
                            <div class="col-lg-4 mb-2 validation_message">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="priority" id="priority" placeholder="Enter Priority" value="{{ old('priority') }}" autocomplete=off />                                    
                                </div>
