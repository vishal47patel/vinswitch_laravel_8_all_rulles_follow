        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('freeswitchServer.store') }}" method="POST" id="check_validation">
                    @csrf
                        <div class="row">
                            <div class="col-lg-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="freeswitch_host" id="freeswitch_host" placeholder="Enter Host" value="{{ old('freeswitch_host') }}" autocomplete = off >
                                </div>
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="freeswitch_password" id="freeswitch_password" placeholder="Enter Password" value="{{ old('freeswitch_password') }}" autocomplete = off >
                                </div>
                            ...
                            <div class="col-lg-6 mb-2">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fa fa-map-signs" aria-hidden="true"></i></span>
                                    <input type="text" class="form-control" name="freeswitch_port" id="freeswitch_port" placeholder="Enter Port" value="{{ old('freeswitch_port') }}" autocomplete = off >
                                </div>
